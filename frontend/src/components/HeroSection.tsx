				...
				<div className="grid lg:grid-cols-2 gap-12 items-center">
					<div className="space-y-8">
						<div className="space-y-6">
							<h1 className="text-4xl lg:text-6xl font-medium text-black leading-tight">{title}</h1>
							<p className="text-lg lg:text-xl text-gray-600 leading-relaxed max-w-lg">{subtitle}</p>
						</div>
