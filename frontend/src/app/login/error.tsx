...
/**
 * Error page component for the login page.
		...
		<div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-indigo-900 px-4">
			<div className="max-w-md w-full text-center bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
				<div className="mb-6">
					...
					<h2 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Login Error</h2>
					<p className="text-gray-600 dark:text-gray-400 mb-6">
						We encountered an issue while setting up your login. Please try again.
					</p>
				</div>
				...
				{process.env.NODE_ENV === "development" && error.message && (
					<div className="mt-6 p-4 bg-red-50 dark:bg-red-900/20 rounded-lg text-left">
						<h3 className="text-sm font-medium text-red-800 dark:text-red-200 mb-2">Error Details (Development)</h3>
						<p className="text-xs font-mono text-red-600 dark:text-red-300 break-all">{error.message}</p>
					</div>
				)}
			</div>
		</div>
