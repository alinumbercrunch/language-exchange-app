			...
			<div className="max-w-md w-full text-center">
				...
				{process.env.NODE_ENV === "development" && error.digest && (
					<div className="mt-6 p-4 bg-red-50 dark:bg-red-900/20 rounded-lg text-left">
						...
						<p className="text-xs font-mono text-red-600 dark:text-red-300">Digest: {error.digest}</p>
						<p className="text-xs font-mono text-red-600 dark:text-red-300 mt-1">{error.message}</p>
					</div>
				)}
			</div>
		</div>
